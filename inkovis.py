...
def plot_confirmed_case(
    ...
    ax.plot(
        ...
        color='#3de3d2', linestyle='--',
        marker='o', markerfacecolor='#a8329b')

    # BAR
    # POSITIVE
    ax.bar(
        x_pos, total_positive, bottom=total_deaths+total_recovered,
        color='#a8329b', label='Dalam Perawatan (Positif COVID-19)'
    )
    ...
    if show_diff_bar:
        ...
        ax.bar(
            ...
            color='#a8329b', edgecolor='black', alpha=0.5
        )
...
def plot_testing_case(
    ...
    ax.bar(
        ...
        color='#3de3d2', label='NEGATIF COVID-19', alpha=0.7
    )
    ...
    if show_diff_bar:
        ...
        ax.bar(
            ...
            color='#3de3d2', edgecolor='black', alpha=0.5
        )
    ...
    if show_numbers:
        for i, val in enumerate(total_tests):
            ...
            ax.annotate(
                ...
                bbox=dict(
                    facecolor='#3de3d2', alpha=0.7, boxstyle='round'
                )
            )
            ...
            if i > 0 and show_diff_numbers:
                ...
                ax.annotate(
                    ...
                    ha='center', va='bottom', size=10,
                    bbox=dict(
                        facecolor='#3de3d2', alpha=0.3, boxstyle='round'
                    )
                )
    ...
    if show_numbers:
        for i, val in enumerate(diff_confirmed):
            ...
            ax.annotate(
                ...
                bbox=dict(
                    facecolor='#a8329b', alpha=1, boxstyle='square'
                )
            )
...
def plot_confirmed_percent(
    ...
    ax.barh(
        ...
        color='#a8329b', label='Dalam Perawatan'
    )
